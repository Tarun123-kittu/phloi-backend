...
router.put("/update_demo_step",authenticateToken,userController.update_demo_step)
...
router.get("/get_maximum_distance_by_admin",authenticateToken,userController.get_maximum_distance_by_admin)
router.put("/update_image_position", authenticateToken, validateUpdateImagePositions, userController.update_image_position)
...
router.put("/undo_disliked_profile",authenticateToken,matchMakingController.undo_disliked_profile)
